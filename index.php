...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-12 offset-md-1 col-md-10 shadow rounded tutto" role="main">
			<div class="row">
			...
			<section id="operational-lab" class="mt-3">
				<div class="d-flex align-items-center justify-content-between mb-3">
					<h2 class="h4 fw-bold mb-0"><?= $service->traduci("tabOperationalLab") ?></h2>
				</div>
				<div class="mb-3">
					<p class="small text-body-secondary mb-0"><?= $service->traduci("operationalLabIntro") ?></p>
				</div>
						...
						<div class="card border-0 shadow-sm">
							...
							<div class="card-body p-4">
								<div class="d-flex align-items-center mb-4">
									...
									<div>
										<h3 class="h5 text-uppercase fw-bold small text-primary mb-1">
...
- <?= $service->traduci("markdownSupportList") ?></textarea>
							...
							<div class="card-body p-4">
								<div class="d-flex align-items-center mb-4">
									...
									<div>
										...
										<small class="text-body"><?= $service->traduci("imageBuilderDesc") ?></small>
									</div>
								</div>
								...
								<div class="row g-4 align-items-start">
									<div class="col-12 col-lg-7">
										<div class="mb-5">
											<h4 class="h6 fw-bold small text-primary mb-3">
												<?= $service->traduci("textSectionTitle") ?>
											</h4>
											<div class="row g-3">
												<div class="col-12">
													<label for="img_text"
														class="form-label fw-semibold small"><?= $service->traduci("imageTextPlaceholder") ?></label>
													<input id="img_text" class="form-control form-control-lg shadow-sm"
														value="<?= htmlspecialchars($service->traduci("imgDinamica")) ?>">
												</div>

												<div class="col-md-5">
													<label for="img_font_family"
														class="form-label small"><?= $service->traduci("imageFont") ?></label>
												...
												<div class="col-6 col-md-3">
													<label for="img_font_size"
														class="form-label small"><?= $service->traduci("imageSize") ?></label>
													<input id="img_font_size" type="number"
														class="form-control shadow-sm" min="10" max="250" value="50">
												</div>
												<div class="col-6 col-md-3">
													<label for="img_txt_color"
														class="form-label small"><?= $service->traduci("imageColorText") ?></label>
													<input id="img_txt_color" type="color"
														class="form-control form-control-color w-100 shadow-sm"
														value="<?= $isDarkTextPreferred ? "#363636" : "#e3e3e3" ?>">
												</div>
											</div>
										</div>
										...
										<div class="mb-4">
											<h4 class="h6 fw-bold small text-primary mb-3">
												<?= $service->traduci("imageSectionTitle") ?>
											</h4>
											<div class="row g-3">
												<div class="col-6 col-md-6">
													<label for="img_bg_color"
														class="form-label small"><?= $service->traduci("imageBg") ?></label>
													<input id="img_bg_color" type="color"
														class="form-control form-control-color w-100 shadow-sm"
														value="<?= htmlspecialchars($colori["colorTema"]) ?>">
												</div>
												<div class="col-6 col-md-6">
													<label for="img_width"
														class="form-label small"><?= $service->traduci("imageWidth") ?></label>
													<div class="input-group shadow-sm">
														<input id="img_width" type="number" class="form-control"
															min="300" max="1800" step="50" value="900">
										...
										<div class="d-flex gap-2 pt-3 border-top mt-4">
											<button id="download_image"
												class="btn btn-dark px-4 shadow-sm"><?= $service->traduci("salva") ?></button>
											<button id="share_image"
												class="btn btn-outline-success px-4 shadow-sm"><?= $service->traduci("condividi") ?></button>
										</div>
									</div>

									<div class="col-12 col-lg-5 text-center">
										<div class="preview-container bg-light rounded-3 p-4 border">
											<p class="small text-body-secondary fw-bold mb-4">
						...
						<div class="card border-0 shadow-sm">
							<div class="card-body p-4">
								...
								<p class="small text-body-secondary mt-3 mb-0">
									<?= $service->traduci("contextMenuHint") ?>
								</p>
							</div>
						</div>
					</div>
			...
			<section id="system-api" class="mt-4 pt-3 border-top">
				<div class="d-flex align-items-center justify-content-between mb-3">
					<h2 class="h4 fw-bold mb-0"><?= $service->traduci("tabSystemApi") ?></h2>
				</div>
				<div class="mb-3">
					<p class="small text-body-secondary mb-0"><?= $service->traduci("internalsIntro") ?></p>
				</div>

				<div class="d-flex align-items-center justify-content-between mt-2 mb-2">
					<h3 class="h5 text-uppercase fw-bold small text-primary mb-0">Frontend</h3>
				</div>
				<div class="row g-3 text-start">
					<div class="col-12 col-lg-3">
						<div class="card border-0 shadow-sm h-100">
							<div class="card-body p-4">
								<h3 class="h5 text-uppercase fw-bold small text-primary mb-3">
									<?= $service->traduci("accessibilityCardTitle") ?>
								</h3>
								<p class="small text-body mb-3"><?= $service->traduci("internalsThemeDesc") ?></p>
								<div
					...
					<div class="col-12 col-lg-3">
						<div class="card border-0 shadow-sm h-100">
							<div class="card-body p-4">
								<h3 class="text-uppercase fw-bold small text-primary mb-3">
									<?= $service->traduci("systemLanguagesTitle") ?> <span
										class="badge bg-info ms-1"><?= $totalLanguages ?></span>
								</h3>
								<p class="small text-body mb-3"><?= $service->traduci("internalsLanguageDesc") ?>
								</p>
					...
					<div class="col-12 col-lg-6">
						<div class="card border-0 shadow-sm h-100">
							<div class="card-body p-4">
								...
								<p class="small text-body mb-3"><?= $service->traduci("assetResolverDesc") ?></p>
								<label for="asset_id"
				...
				<div class="d-flex align-items-center justify-content-between mt-4 mb-2">
					<h3 class="h5 text-uppercase fw-bold small text-primary mb-0">Backend</h3>
				</div>
				<div class="row g-3 text-start">
					<div class="col-12 col-lg-4">
						<div class="card border-0 shadow-sm h-100">
							<div class="card-body p-4">
								...
								<p class="small text-body mb-3"><?= $service->traduci("internalsApiDesc") ?></p>
								<span
								...
								<div class="small text-body-secondary text-break">
									<?= htmlspecialchars($service->urlAPI) ?>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-lg-8">
						<div class="card border-0 shadow-sm h-100">
							<div class="card-body p-4">
								...
								<p class="small text-body mb-3"><?= $service->traduci("apiPlaygroundDesc") ?></p>
								<label for="social_filter"
									class="form-label fw-bold small text-primary"><?= $service->traduci("socialFilterLabel") ?></label>
								<div class="input-group mb-3">
									<input id="social_filter" class="form-control" value="Facebook;twitter;Telegram">
