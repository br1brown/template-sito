...
$pagina = [
    [
        "usoCookie" => [
            "it" => "Il nostro sito web non utilizza cookie. Non vengono raccolti dati attraverso cookie tecnici, di profilazione o di terze parti.",
            "en" => "Our website does not use cookies. No data is collected through technical cookies, profiling cookies, or third-party cookies."
        ]
    ],
    [
        "cosaSonoCookie" => [
    ...
    // [
    //     "comeUsiamoCookie" => [
    //         "it" => "Non applicabile poiché questo sito non utilizza cookie.",
    //         "en" => "Not applicable as this site does not use cookies."
    //     ]
    // ],
    // [
    //     "controlloCookie" => [
